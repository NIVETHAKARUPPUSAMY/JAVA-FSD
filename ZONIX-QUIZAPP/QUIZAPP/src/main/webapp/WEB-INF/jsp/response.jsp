...
<body class="site-container">
	...
	<div id="main-content" class="container">
		<div id="xs-welcome" class="text-center visible-xs">
			<name>Chandrachur Chatterjee</name>
		</div>

		<table class="table table-responsive-sm">
			<thead>
				<tr>
					<th class="text-center" scope="col">Quiz-Id</th>
					<th class="text-center" scope="col">Quiz-Name</th>
					<th class="text-center" scope="col">Attempted on</th>
			...
			<tbody>
				<c:forEach items="${attempts}" var="attempt">
					<tr>
						<th scope="row">${attempt.getQuizid()}</th>
						<td>${quizService.retrieveByQuizId(attempt.getQuizid()).getQuizname()}</td>
						<td>${attempt.getDate()}</td>
