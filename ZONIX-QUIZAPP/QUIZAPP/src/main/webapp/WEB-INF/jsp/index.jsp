				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="card">
						<div class="card-header">
							Quiz id.:<span>${quiz.getQuizid()}</span>
						</div>
						<div class="card-body">
							<h5 class="card-title">
								Quiz Name: <span>${quiz.getQuizname()}</span>
							</h5>
							<hr />
							<p class="card-text">${quiz.getQuizdetails()}</p>
							<a href="/user/${quiz.getQuizid()}/start" class="btn btn-primary">Attend
								Quiz</a>
						</div>
