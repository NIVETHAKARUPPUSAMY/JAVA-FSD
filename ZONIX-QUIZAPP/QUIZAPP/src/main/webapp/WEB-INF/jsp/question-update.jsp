...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="">ZONIX QUIZ-APP</a>
			</div>
	...
	<div class="container">
		<h1>
			QUESTION UPDATE FOR QUIZ-ID: <b>QUIZ-101</b>
		</h1>

		<form action="/admin/${quizid}/view/${questionid}/update/success"
			method="post">
			...
			<fieldset class="form-group">
				<input type="text" name="questiondetails"
					...
					id="qdata" value="${question.getQuestiondetails()}"
					required="required" /> <label for="qdata" class="form-label">ENTER
			...
			<fieldset class="form-group">
				<input type="text" name="option1" placeholder="ENTER OPTION-1"
					class="form-control" id="qop1"
					value="${options.get(0).getOptionvalue()}" required="required" />
				<label for="qop1" class="form-label">ENTER OPTION-1</label>
			</fieldset>

			<fieldset class="form-group">
				<input type="text" name="option2" placeholder="ENTER OPTION-2"
					class="form-control" id="qop2"
					value="${options.get(1).getOptionvalue()}" required="required" />
				<label for="qop2" class="form-label">ENTER OPTION-2</label>
			</fieldset>

			<fieldset class="form-group">
				<input type="text" name="option3" placeholder="ENTER OPTION-3"
					class="form-control" id="qop3"
					value="${options.get(2).getOptionvalue()}" required="required" />
				<label for="qop3" class="form-label">ENTER OPTION-3</label>
			</fieldset>

			<fieldset class="form-group">
				<input type="text" name="option4" placeholder="ENTER OPTION-4"
					class="form-control" id="qop4"
					value="${options.get(3).getOptionvalue()}" required="required" />
				<label for="qop4" class="form-label">ENTER OPTION-4</label>
			</fieldset>
			...
			<fieldset class="form-group">
				<input type="text" name="correctans" id="opt4"
					...
					id="corrans" aria-describedby="note"
					value="${question.getCorrectanswer()}" required="required" /> <label
