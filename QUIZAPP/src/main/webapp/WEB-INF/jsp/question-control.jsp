...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="/admin/quiz-control">ZONIX-QUIZAPP</a>
			</div>
	...
	<div class="container">
		<h1>
			ZONIX QUESTION CONTROL FOR QUIZ ID: <b>QUIZ-101</b>
		</h1>
		<h4>
			Quiz Name : <i>${quiz.getQuizname()}</i>
		</h4>
		<h4>
			Quiz Details : <i>${quiz.getQuizdetails()}</i>
		</h4>
		<br> <br>
		<table class="table">
			<tr>
			...
			<c:forEach items="${questions}" var="question">
				<tr>
					...
					<td>
						<form
							action="/admin/${quiz.getQuizid()}/view/questions/${question.getQuestionid()}"
							method="get">
							<input type="submit" class="btn btn-info" value="VIEW QUESTION" />
						</form>
					</td>
					<td>
						<form
							action="/admin/${quiz.getQuizid()}/view/${question.getQuestionid()}/update"
							method="get">
					...
					<td>
						<form
							action="/admin/${quiz.getQuizid()}/delete/${question.getQuestionid()}/success"
							method="post">
		...
		<a href="/admin/${quiz.getQuizid()}/question-add"><button
				class="btn btn-success">ADD A QUESTION</button></a>
	</div>
