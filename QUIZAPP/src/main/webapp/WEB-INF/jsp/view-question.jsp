...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a
					href="/admin/quiz-control/${quiz.getQuizid()}/question-control">GO
						TO QUESTION CONTROL PAGE</a></li>
			</ul>
	...
	<div class="container">
		<h1>VIEW QUESTIONS FOR QUIZ ID: ${quiz.getQuizid()}</h1>
		<h3>
		...
		<h3>Question ID: ${question.getQuestionid()}</h3>
		<h3>Question Details: ${question.getQuestiondetails()}</h3>
		<c:forEach items="${options}" var="option">
			<label>Option: ${option.getOptionvalue()}</label>
			<br />
		</c:forEach>
		<h3>
			Correct Answer: <b>${question.getCorrectanswer()}</b>
		</h3>
	</div>
