...
<body class="site-container">
			...
			<div class="container-fluid">
				...
				<div class="dropdown pull-right hidden-xs">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="/user/previous-attempts"><span class="glyphicon glyphicon-stats"></span>View
								Previous attempts</a></li>
						<li role="separator" class="divider"></li>
	...
	<div id="main-content" class="container">
		...
		<div id="message">Quiz has Ended.</div>

		<div class="card text-center">
			<div class="card-header">
				Quiz Name:<span>Maths</span>
			</div>
			<div class="card-body">
				<h5 class="card-title">
					Quiz id:<span>1234</span>
				</h5>
				<hr>

				<div class="intro">
					<div>
						Total number of questions:<span id="totques">${outof}</span>
					</div>
					<div>
						Total number of correct answers:<span id="totans">
							${points}</span>
					</div>

					<div id="highlight">
						Score:<span id="score">${points} / ${outof}</span>
					</div>
				</div>
	...
	<div class="push"></div>
        ...
        <footer class="panel-footer">
            <div class="container-fluid">
             <section>  
             <a href="/user/contact"><span class="glyphicon glyphicon-send"></span> Contact Us.</a> 
             </section>    
            </div>
        </footer> 
