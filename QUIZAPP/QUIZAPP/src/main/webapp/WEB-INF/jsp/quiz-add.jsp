...
<body>
	...
	<div class="container">
		...
		<form action="/admin/quiz-add-success" method="post">
			<fieldset class="form-group">
				<input type="text" name="quizid" placeholder="ENTER QUIZ-ID"
					class="form-control" id="qid" required="required" /> <label
					for="qid" class="form-label">ENTER QUIZ-ID</label>
			</fieldset>

			<fieldset class="form-group">
				<input type="text" name="quizname" placeholder="ENTER QUIZ-NAME"
					class="form-control" id="qname" required="required" /> <label
					for="qname" class="form-label">ENTER QUIZ-NAME</label>
			</fieldset>

			<fieldset class="form-group">
				<input type="text" name="quizdesc"
					placeholder="ENTER QUIZ DESCRIPTION" class="form-control" id="qdes"
					required="required" /> <label for="qdes" class="form-label">ENTER
