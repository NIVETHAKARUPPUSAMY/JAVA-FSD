...
<body>
	...
	<div class="container">
		...
		<table class="table">
			...
			<c:forEach items="${quizes}" var="quiz">
				<tr>
					...
					<td>
						<form
							action="/admin/quiz-control/${quiz.getQuizid()}/question-control"
							method="get">
							<input type="submit" class="btn btn-info" value="GO INSIDE" />
						</form>
					</td>
					<td>
						<form action="/admin/quiz-control/${quiz.getQuizid()}/update"
							method="get">
							<input type="submit" class="btn btn-success" value="UPDATE" />
						</form>
					</td>
					<td>
						<form action="/admin/quiz-control/${quiz.getQuizid()}/delete"
							method="post">
		...
		<a href="/admin/quiz-add"><button class="btn btn-success">ADD
				A QUIZ</button></a>
	</div>
